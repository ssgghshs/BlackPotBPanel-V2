<template>
  <div class="database-container">
    <nav class="horizontal-menu" v-if="showNav">
      <ul>
        <li><router-link to="/database/mysql">MySQL</router-link></li>
        <li><router-link to="/database/postgresql">PostgreSQL</router-link></li>
        <li><router-link to="/database/sqlite">SQLite</router-link></li>
      </ul>
    </nav>
    <router-view />
  </div>
